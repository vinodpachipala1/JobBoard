...
const HomePage = () => {
    ...
    const featuredJobs = Jobs?.sort((a, b) => { return new Date(b.created_at) - new Date(a.created_at) }).slice(0, 6);
        ...
        <div className="p-4 flex-1">
            ...
            <section className="relative bg-[url('../public/home1.png')] bg-cover bg-center text-white">
                ...
                <div className="relative container mx-auto sm:pt-0 pt-4 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center min-h-[60vh] text-center">
                    ...
                    <form className="mt-8 w-full max-w-2xl bg-white/10 p-4 rounded-lg backdrop-blur-md border border-white/20">
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="relative flex-grow">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg className="h-5 w-5 text-gray-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
                                </div>
                                <input type="text" placeholder="Job title or keyword" className="w-full pl-10 pr-4 py-3 bg-transparent border-b border-white/50 text-white placeholder-gray-300 focus:outline-none focus:border-sky-400" />
                            </div>
                            <div className="relative flex-grow">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <input type="text" placeholder="Location" className="w-full pl-10 pr-4 py-3 bg-transparent border-b border-white/50 text-white placeholder-gray-300 focus:outline-none focus:border-sky-400" />
                            </div>
                            <button type="submit" className="px-6 py-3 bg-sky-600 rounded-md hover:bg-sky-700 text-white font-semibold transition-colors duration-300">
                                Find Jobs
                            </button>
                        </div>
                    </form>
            ...
            <section className="bg-white py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {loading ? <div class="flex justify-center">
