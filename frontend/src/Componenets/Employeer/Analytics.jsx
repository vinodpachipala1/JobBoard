    ...
    return (<><div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-sky-50 to-blue-50 px-6 py-4 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                <div>
                    <h3 className="text-xl font-bold text-gray-900">Job Analytics</h3>
        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-gradient-to-br from-blue-50 to-sky-100 rounded-xl p-6 border border-blue-200 shadow-sm">
                    ...
                    <div className="text-sm font-semibold text-blue-800">Total Applications</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 border border-green-200 shadow-sm">
                    ...
                    <div className="text-sm font-semibold text-green-800">Reviewed</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl p-6 border border-purple-200 shadow-sm">
                    ...
                    <div className="text-sm font-semibold text-purple-800">Shortlisted</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-amber-100 rounded-xl p-6 border border-orange-200 shadow-sm">
                    ...
                    <div className="text-sm font-semibold text-orange-800">Days Remaining</div>
                </div>
            </div>
