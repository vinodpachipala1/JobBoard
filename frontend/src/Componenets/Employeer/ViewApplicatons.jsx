                                    ...
                                    <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-5">
                                        ...
                                        <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row items-stretch gap-3 min-w-[280px]">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <button onClick={() => handleContact(application.candidate_email)} className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-sky-500 to-blue-500 text-white rounded-lg text-sm font-semibold hover:from-sky-600 hover:to-blue-600 transition-all shadow-sm hover:shadow flex-1 justify-center">
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
